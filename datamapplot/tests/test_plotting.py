...
def test_plot_cord19(
    ...
    fig = run_static_examples_script(
        "plot_cord19.py", examples_dir, change_np_load_path, mock_savefig
    )
    return fig
...
def test_plot_arxiv_ml(
    ...
    fig = run_static_examples_script(
        "plot_arxiv_ml.py", examples_dir, change_np_load_path, mock_savefig
    )
    return fig
...
def test_plot_arxiv_ml_edge_bundle(
    ...
    fig = run_static_examples_script(
        "plot_arxiv_ml_edge_bundle.py", examples_dir, change_np_load_path, mock_savefig
    )
    return fig
...
def test_plot_arxiv_ml_word_cloud(
    ...
    fig = run_static_examples_script(
        "plot_arxiv_ml_word_cloud.py", examples_dir, change_np_load_path, mock_savefig
    )
    return fig
...
def test_plot_wikipedia(
    ...
    fig = run_static_examples_script(
        "plot_wikipedia.py", examples_dir, change_np_load_path, mock_savefig
    )
    return fig
...
def test_plot_simple_arxiv(
    ...
    fig = run_static_examples_script(
        "plot_simple_arxiv.py", examples_dir, change_np_load_path, mock_savefig
    )
    return fig


def run_static_examples_script(
    script_filename, script_dir, change_np_load_path, mock_savefig
):
    """
